...
module.exports = class Db1760043553342 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` ADD \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` ADD \`deletedAt\` timestamp(6) NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` ADD \`deletedAt\` datetime(0) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`tipo_usuario\` ADD \`createdAt\` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
