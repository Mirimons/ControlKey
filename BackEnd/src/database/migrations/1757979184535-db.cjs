 ...
 */
module.exports = class Db1757979184535 {
    name = 'Db1757979184535'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`equipamento\` (\`id\` int UNSIGNED NOT NULL AUTO_INCREMENT, \`id_tipo\` int UNSIGNED NOT NULL, \`desc_equip\` varchar(100) NOT NULL, \`status\` enum ('livre', 'ocupado') NOT NULL DEFAULT 'livre', \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
