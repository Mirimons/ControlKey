 ...
 */
module.exports = class Db1759178438430 {
    name = 'Db1759178438430'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`labs\` (\`id\` int UNSIGNED NOT NULL AUTO_INCREMENT, \`nome_lab\` varchar(50) NOT NULL, \`desc_lab\` varchar(100) NULL, \`status\` enum ('livre', 'ocupado') NOT NULL DEFAULT 'livre', \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
