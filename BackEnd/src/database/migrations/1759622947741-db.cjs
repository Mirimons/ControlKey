 ...
 */
module.exports = class Db1759622947741 {
    name = 'Db1759622947741'

    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`control\` CHANGE \`aberto\` \`ciente\` tinyint NULL DEFAULT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`control\` CHANGE \`ciente\` \`ciente\` tinyint NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`control\` CHANGE \`ciente\` \`ciente\` tinyint NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`control\` CHANGE \`ciente\` \`aberto\` tinyint NULL DEFAULT 'NULL'`);
    }
}
