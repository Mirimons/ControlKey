 ...
 */
module.exports = class Db1749063872423 {
    name = 'Db1749063872423'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`usuario_cad\` (\`id_usuario\` int UNSIGNED NOT NULL, \`matricula\` varchar(10) NOT NULL, \`email_institucional\` varchar(100) NOT NULL, \`senha\` varchar(50) NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, UNIQUE INDEX \`IDX_cfbeb39635dde17f08a9323cf0\` (\`email_institucional\`), PRIMARY KEY (\`id_usuario\`)) ENGINE=InnoDB`);
