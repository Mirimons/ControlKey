 ...
 */
module.exports = class Db1749063719838 {
    name = 'Db1749063719838'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`usuario\` (\`id\` int UNSIGNED NOT NULL AUTO_INCREMENT, \`cpf\` char(11) NOT NULL, \`nome\` varchar(100) NOT NULL, \`telefone\` varchar(15) NOT NULL, \`data_nasc\` date NOT NULL, \`id_tipo\` int UNSIGNED NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, UNIQUE INDEX \`IDX_28cd8597e57c8197d4929a98e7\` (\`cpf\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
